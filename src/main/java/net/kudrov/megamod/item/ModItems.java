package net.kudrov.megamod.item;

import net.kudrov.megamod.MptMod;
...
public class ModItems {
    ...
    public static final RegistryObject<Item> MULTITOOL = ITEMS.register("multitool",
            () -> new MultiTool(ModWeaponMaterials.AMBER,
                    new Item.Properties().tab(ModCreativeModeTab.MPT_TAB).stacksTo(1)));
